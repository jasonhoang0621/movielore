            ...
            <div className="create-container">
                ...
                <div className="first-block">
                    <div className="information">
                        ...
                        <input type="text" id="first-release-day" className="block-input" placeholder="DD/MM/YYYY" value={data.releaseDate} onChange={event => setData({ ...data, releaseDate: event.target.value })} />

                        <label htmlFor="first-time-long" className="block-label">Thời lượng phim:</label>
                        <input type="text" id="first-time-long" className="block-input" placeholder="vd: 180 phút" value={data.time} onChange={event => setData({ ...data, time: event.target.value })} />
                ...
                <div className="second-block">
                    ...
                    <input type="text" id="second-writters" className="block-input" placeholder="vd: Robert Zemeckis, Robert Zemeckis, J.K. Rowling,..." value={data.author} onChange={event => setData({ ...data, author: event.target.value })} />

                    <label htmlFor="second-director" className="block-label">Đạo diễn:</label>
                    <input type="text" id="second-director" className="block-input" placeholder="vd: Christopher Nolan, Robert Zemeckis, Robert Zemeckis,..." value={data.director} onChange={event => setData({ ...data, director: event.target.value })} />

                    <label htmlFor="second-cast" className="block-label">Diễn viên:</label>
                    <input type="text" id="second-cast" className="block-input" placeholder="vd: Tom Hank, Emma Stone, Johnny Depp,..." value={data.cast} onChange={event => setData({ ...data, cast: event.target.value })} />
                </div>
                ...
                <div className="plot-block">
                    ...
                    <textarea id="plot-input" className="block-input" placeholder="Nội dung chính của phim" value={data.plot} onChange={event => setData({ ...data, plot: event.target.value })} />
                </div>
                ...
                <div className="rate-block">
                    <span>Đánh giá:</span>
                    <input type="text" className="rate-input" value={data.rate} onChange={event => setData({ ...data, rate: event.target.value })} />
                    <span>/10</span>
                ...
                <div className="submit-block">
                    ...
                    <button className="submit-btn" onClick={handleSubmitAll}>ĐĂNG BÀI</button>
                </div>
            </div>
        </div>
    )
